      ...
      <div className="left-side">
        <form>
          ...
          <div className="buttons">
            ...
            <button className="percentage-btn" value='10' onClick={handleButton}>
              10%
            </button>
            <button className="percentage-btn" value='15' onClick={handleButton}>
              15%
            </button>
            <button className="percentage-btn" value='20' onClick={handleButton}>
              25%
            </button>
            <button className="percentage-btn" value='25' onClick={handleButton}>
              50%
            </button>
          ...
          <div className="input-div">
            ...
            {people === 0 ? (
              <label htmlFor="no-of-people">Ne moze biti 0</label>
            ) : (
              <input
                type="number"
                placeholder="0"

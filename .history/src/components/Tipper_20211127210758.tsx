...
const Tipper: React.FC<Props> = ({bill, people, total, handleChange, handlePeople}) => {
  return (
        ...
        <div className="left-side">
          <form>
            ...
            <div className="input-div">
              ...
              <input type="number" placeholder="0" value={bill} onChange={handleChange}/>
            </div>
            ...
            <div className="input-div">
              ...
              <input type="number" placeholder="0" value={people} onChange={handlePeople}/>
            </div>
          </form>
        </div>
